...
export default function Navbar() {
    ...
    <div>
        ...
        <nav>
            ...
            <ul className={`${menuClicked ? 'flex' : 'hidden'} bg-[#ffffff] bg-opacity-5 backdrop-blur-[40.7742px] py-[118px] w-[254px] h-[667px] absolute right-0 top-[0px] flex-col pl-[32px] font-bold text-[20px] gap-8
