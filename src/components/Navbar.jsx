...
export default function Navbar() {
    ...
    const isActive = (section) => {
        // Comprueba si la ubicación actual coincide con la sección proporcionada
    ...
    <div>
        ...
        <nav>
            ...
            sm:flex sm:flex-row sm:top-0 sm:w-[450px] sm:h-[100px] sm:relative sm:justify-end sm:gap-5
            lg:w-[830px] lg:gap-[50px] lg:pr-[150px]

            sm:py-10 sm:pr-9
            `}>
                <li className={`text-TextW cursor-pointer text-[16px] font-bold leading-normal tracking-[2.7px] sm:text-sm lg:flex lg:gap-1 ${isActive('/')}`}>
                    <Link to={'/'}>
                ...
                <li className={`text-TextW cursor-pointer text-[16px] font-bold leading-normal tracking-[2.7px] sm:text-sm lg:flex lg:gap-1 ${isActive('/destinations')}`}>
                ...
                <li className={`text-TextW cursor-pointer text-[16px] font-bold leading-normal tracking-[2.7px] sm:text-sm lg:flex lg:gap-1 ${isActive('/crew')}`}>
                    <Link to={'/crew'}>
                        <div className=' lg:flex lg:items-center lg:gap-[5px]'>
                ...
                <li className={`text-TextW cursor-pointer text-[16px] font-bold leading-normal tracking-[2.7px] sm:text-sm lg:flex lg:gap-1 ${isActive('/technology')}`}>
                    <Link to={'/technology'}>
                        <div className=' lg:flex lg:items-center lg:gap-[5px]'>
